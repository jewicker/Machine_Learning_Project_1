    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                transformed_object_file_path = save_object(self.data_transformation_config.transformed_object_file_path, preprocessor)
                transformed_train_file_path = save_numpy_array_data(self.data_transformation_config.transformed_train_file_path, array=train_arr)
                transformed_test_file_path = save_numpy_array_data(self.data_transformation_config.transformed_test_file_path, array=test_arr)
