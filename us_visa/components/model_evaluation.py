    ...
    def get_best_model(self) -> Optional[USvisaEstimator]:
        ...
        try:
            ...
            if not os.getenv("AWS_ACCESS_KEY_ID"):
                logging.warning("AWS_ACCESS_KEY_ID environment variable is not set. Skipping production model lookup in S3.")
                return None
            ...
            logging.warning(f"Failed to fetch model from S3: {e}. Skipping production model evaluation.")
            return None
